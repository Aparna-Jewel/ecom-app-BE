...
public record SessionProperties(
    ...
    public record SessionPolicy(
        ...
        @AssertTrue(
            message = "Session timeouts must be positive, activity refresh must be less than idle timeout, and idle timeout must not exceed absolute timeout"
        )
        public boolean isValid() {
            ...
            return !idleTimeout.isNegative() && !idleTimeout.isZero()
